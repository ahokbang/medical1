''' 변수
기본형으로 bool, int, float, string 4개가 있어. ********** 꼭 외우기 **********
list, tuple, dict
예를 들어
'''
a = True
...
# input() - 콘솔창에서 입력을 받는다. 
print("글자를 콘솔창에 보여준다.")
input('입력하세요. >> ') # 콘솔창에서 입력을 받는다는 의미. 어떠한 변수로 받아서 사용. 입력한 값이 변수에 저장 돼.
str1 = input("입력하세요. >> ")
print("{}은 입력한 변수값입니다." .format(str1))

n1 = input("첫번째 숫자를 입력하세요. >> ") # 10
n2 = int(input("두번째 숫자를 입력하세요. >> ")) # 3
# n1 * n2 값을 출력해보세요. 출력 : 30
print("{} * {} = {}" .format(n1, n2, (int(n1)*n2)))

'''선생님 답
input()을 통해서 입력 받는 것은 문자다. 10이라고 입력해도 컴퓨터는 '10'으로 인식
print(n1 * n2) : 문자 * 숫자가 되서 문자가 숫자만큼 반복
